...
class TestDeployAuthIntegration:
    def test_dynamic_verifier_falls_back_to_oauth_bridge(self, monkeypatch, tmp_path):
        ...
        verifier = build_token_verifier("TEST4", bridge)
    ...
    def test_build_token_verifier_open_mode_still_none(self, monkeypatch):
        ...
        assert build_token_verifier("TEST6") is None
